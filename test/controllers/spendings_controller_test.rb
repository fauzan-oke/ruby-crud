...
class SpendingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spending" do
    assert_difference("Spending.count") do
      post spendings_url, params: { spending: { date: @spending.date, employeeID: @spending.employeeID, value: @spending.value } }
    end
  ...
  test "should update spending" do
    patch spending_url(@spending), params: { spending: { date: @spending.date, employeeID: @spending.employeeID, value: @spending.value } }
